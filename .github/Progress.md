...
- [x] Ensure RPM uses correct source tarball when building on GitHub Actions. Currently, it always uses the latest develop branch.
- [ ] Add JXL support via libjxl + ImageSharp
